...
def generate():
  ...
  response = openai.ChatCompletion.create(
    ...
    messages=[
          ...
          It has to be in array of dictionnaries, each representing an event, with the following format: {name, description, startDate, endDate}. 
  ...
  df.to_csv('space-exploration.csv', index=False)
